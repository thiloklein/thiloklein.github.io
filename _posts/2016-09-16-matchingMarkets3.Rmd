...
This post builds on my previous post on [sorting bias in endogenous groups](http://klein.uk/blog/2016/07/matchingMarkets2/) to ilustrate a method to draw causal inference from endogenously formed groups.<!--more-->
