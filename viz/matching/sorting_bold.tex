...
\begin{tikzpicture}[domain=0:4, scale=1.65, line width=0.5mm, font=\bf] %
%axis
	\draw[->] (-0.2,0) -- (4.5,0) node[below right] {X};
	\draw[->] (0,-.2) -- (0,4.2) node[above left] {R};
%legend 1
...
% legend 2
  \begin{scope}[shift={(0.85,3.55)}] 
	\draw[yshift=0.6\baselineskip, color=darkred] (0,0) -- 
		...
		node[right, color=darkred]{systematic matching};
  \end{scope}
  \pause
  %points 2
...
% convert -verbose -delay 200 -loop 0 -density 600 sorting.pdf sorting.gif
